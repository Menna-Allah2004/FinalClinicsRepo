...
namespace ClinicPatient.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        public async Task<IActionResult> Dashboard()
        {
            ...
            var recentMessages = (await _unitOfWork.ContactUsMessages.GetAsync(null, q => q.OrderByDescending(m => m.CreatedAt))).Take(5).Select(m => new ContactUsMessageViewModel
            {
                Id = m.Id,
                Name = m.Name,
                Email = m.Email,
        ...
        public async Task<IActionResult> Messages()
        {
            ...
            var viewModels = messages.Select(m => new ContactUsMessageViewModel
            {
                Id = m.Id,
                Name = m.Name,
                Email = m.Email,
